%%%% This script extracts the inphase spatiotemporal features using Gabor decomposition of the natural videos %%%%%%%%%
...
xi = 0; opt = 1; bandwidth = 1;
features_set_cos = zeros(N,48);
for v_id = 1:1:N
    v_id
    features = [];
    ...
    features_set_cos(v_id,:) = features;
    clear G;
    save('spatiotemporal_inphase_features.mat','features_set_cos','-v7.3');
end
